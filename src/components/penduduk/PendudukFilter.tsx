        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-end gap-4 bg-gray-50/50">
            ...
            <div>
                ...
                <input
                    ...
                    className="mt-1 w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
            </div>
            ...
            <div>
                ...
                <select
                    ...
                    className="mt-1 w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:bg-gray-200"
                >
