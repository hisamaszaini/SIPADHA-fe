  ...
  return (
    <>
      ...
      <p style={{ textAlign: "justify", padding: "0pt 5.4pt" }}>
        <span style={{ fontFamily: '"Bookman Old Style", "URW Bookman L", "Times New Roman", serif' }}>Dengan ini menerangkan {"  "}:</span>
      </p>
      <table style={{ padding: "0pt", borderCollapse: "collapse" }}>
        <tbody>
          <tr>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", padding: "0pt" }}>
        <tbody>
          {/* Baris tanggal di kanan */}
          <tr>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", fontFamily: '"Bookman Old Style"' }}>
              &nbsp;
            </td>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", textAlign: "center", fontFamily: '"Bookman Old Style"' }}>
          ...
          {/* Spasi tanda tangan */}
          <tr>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", height: "70pt", fontFamily: '"Bookman Old Style"' }}></td>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", fontFamily: '"Bookman Old Style"' }}></td>
          </tr>

          {/* Nama pemohon & kepala desa */}
          <tr>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", textAlign: "center", fontFamily: '"Bookman Old Style"' }}>
              <strong><u>{data.penduduk.nama.toUpperCase()}</u></strong>
            </td>
            <td style={{ width: "50%", padding: "0pt 5.4pt", verticalAlign: "top", textAlign: "center", fontFamily: '"Bookman Old Style"' }}>
              <strong><u>{data.setting.namaKepdes}</u></strong>
            </td>
          </tr>
        </tbody>
      </table>
