        ...
        <div>
            ...
            <div className="p-4 flex flex-col md:flex-row items-center gap-4 bg-white">
                <select 
                    ...
                    className="filter-select mt-1 w-full md:w-64 px-3 py-2.5 bg-white border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500">
